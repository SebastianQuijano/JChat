 ...
 * Interfaz del Chat
 **/
public class GUIJChat extends JFrame {
	...
	/*************************************************************************/  
	private JButton buttonFontChange;      
	private JButton buttonSelectColor;
	private JButton buttonSendText;
	private JButton buttonEmoticons;
	 ...
	 * */
	public GUIJChat() {
		super("| JChat Aplicacion 1.0 |");
	  checkSO();
		final JRootPane rootPane =  this.getRootPane();
	    //Iconos
		final ImageIcon iconEmoticons = new ImageIcon(getClass().getResource(
				"/content/Icons/iconEmoticons.gif"));
		final ImageIcon iconFont = new ImageIcon(getClass().getResource(
				"/content/Icons/iconFont.png"));
		final ImageIcon iconDisconnect = new ImageIcon(getClass().getResource(
				"/content/Icons/iconDisconnect.jpg"));
		final ImageIcon iconColors = new ImageIcon(getClass().getResource(
				"/content/Icons/iconColors.gif"));
	     iconConnect = new ImageIcon(getClass().getResource(
				"/content/Icons/online.png"));
	     
	    iconTabUser   = new ImageIcon(getClass().getResource("/content/Icons/iconTabUsers.png"));
...
//		documentMain.addDocumentListener(controlleMainDocumentListener);
		...
		buttonFontChange    = new javax.swing.JButton("Cambiar Fuente");
		buttonSelectColor   = new JButton("Color");
		buttonEmoticons     = new JButton("");
		buttonBold          = new JToggleButton("B");

		scrollPaneMainArea.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		buttonEmoticons   .setIcon(iconEmoticons);
		...
		buttonEmoticons   .setText("Emoticonos");
		buttonFontChange  .setIcon(iconFont);
		buttonSelectColor .setFocusable(false);
		buttonSelectColor .setIcon(iconColors);
		buttonEmoticons   .setToolTipText("Emoticonos");
		buttonSelectColor .setToolTipText("Selecciona el folor de tu fuente");
		buttonBold        .setToolTipText("Negrita");

		buttonSendText = new javax.swing.JButton("Enviar");
		...
		buttonEmoticons   .setBorder(BorderFactory.createEtchedBorder());
		buttonSendText    .setFocusable(false);
		buttonFontChange  .setBorder(BorderFactory.createEtchedBorder());
	
		toolBar.add(buttonBold);
		toolBar.add(buttonSelectColor);
		toolBar.add(buttonFontChange);
		toolBar.add(buttonEmoticons);
		toolBar.add(glassPanelVert);
		
		toolBar.setLayout(new FlowLayout(FlowLayout.LEFT));
		panelToolbar.setLayout(new GridLayout(1, 1));
		panelToolbar.add(toolBar);

		buttonFontChange     .setPreferredSize(new Dimension(140, 25));
		buttonEmoticons      .setPreferredSize(new Dimension(140, 25));
		buttonSelectColor    .setPreferredSize(new Dimension(100, 25));
		buttonSelectColor    .setBorder(BorderFactory.createEtchedBorder());
		buttonBold           .setPreferredSize(new Dimension(40, 25));
	...
	//	itemAbout         .addActionListener(controllerListerner);
	...
	/***
	 * @Metodo checkeo de Sistema Operativo
	 **/
	public void checkSO() {
	
     }
	/***
	 * @Metodo Muestra los mensajes en el area principal
	 **/

...
public class ControllerListerner implements ActionListener {
	 ...
	 * @param Interfaz
	 **/
	public ControllerListerner(GUIJChat c) {
		client = c;
	}
	@Override
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equalsIgnoreCase("Acerca de..")) {
			new About(client,true);
		}
		...
		if (e.getActionCommand().equalsIgnoreCase("Emoticonos")) {
			if (verifyEmoticons) {
